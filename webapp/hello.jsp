	...
	<div id="loginForm_wrap">
		...
		<form id="loginForm" action="/login" method="POST">
			...
			<div>
				...
				<div class="login_info_list">
					<div class="float_left login_info_list_name">
						학년<br>(2014년 1학기에 해당하는 학년)
					</div>
					<select class="form_width" name="grade" id="grade">
				...
				<div class="login_info_list">
					...
					<input class="form_width" type="text" maxlength="15" name="identification" id="identification" size="15" placeholder="학번" >
				</div>
				...
				<div class="login_info_list">
					...
					<select class="form_width" name="why" id="why">
...
<div>
	...
	<div class="notice">
		<div class="notice_title">&lt;안내문&gt;</div>
