...
<div class="hero-unit">
	...
	<p class="lead text-error">주의: 과목을 선택한 후 반드시 예비 수강신청 확정을 누르셔야 정상적으로 접수됩니다.</p>
</div>

<hr>

<div>
	<div class="inline-block"><h3>개설 전공</h3></div>
...
<table id="korean" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>국어국문학과</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<table id="psy" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>심리학과</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<table id="chulhak" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>철학과</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<table id="money" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>경제학과</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<table id="untong" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>응용통계학과</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<table id="jungchi" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>정치외교학과</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<table id="social" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>사회학과</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<table id="press" style="display: none;" class="table table-hover table-condensed courseList">
	<caption class="text-center"><strong><h4>언론홍보영상학부</h4><strong></caption>
	<thead>
	<tr>
		<th>학년</th>
		<th>종별</th>
...
<div class="span3 offset4"><button id="submit" class="btn btn-large btn-primary" onclick="submit()">예비 수강신청 확정</button></div>
</div>
